...
Avoid saying the fields “repel” — say “interact”.`
  ...
  {id:"force_dir_3", tags:["lefthand","motoreffect"], difficulty:"hard", type:"mcq",
    ...
    answerIndex:1,
    explanation:"Use Fleming’s left-hand rule (FBI). Current is out of the page (•) and field is down, so the force is to the right."},
...
• Cone vibrates back and forth, making air vibrate → sound (longitudinal wave).`
  ...
  {"id": "force_dir_extra_4", "tags": ["lefthand", "motoreffect"], "difficulty": "hard", "type": "mcq", "prompt": "Magnetic field is down. Current is left. Force is:", "choices": ["into the page", "out of the page", "up", "down"], "answerIndex": 1, "explanation": "Use Fleming’s left-hand rule (FBI). Left (−x) × down (−y) = out of the page (+z)."},
  ...
  {"id": "force_dir_extra_7", "tags": ["lefthand", "motoreffect"], "difficulty": "hard", "type": "mcq", "prompt": "Magnetic field is left. Current is out of the page (•). Force is:", "choices": ["up", "down", "into the page", "out of the page"], "answerIndex": 1, "explanation": "Use Fleming’s left-hand rule (FBI). Out of page (+z) × left (−x) = down (−y)."},
  {"id": "force_dir_extra_8", "tags": ["lefthand", "motoreffect"], "difficulty": "hard", "type": "mcq", "prompt": "Magnetic field is into the page (×). Current is left. Force is:", "choices": ["up", "down", "left", "right"], "answerIndex": 1, "explanation": "Use Fleming’s left-hand rule (FBI). Left (−x) × into page (−z) = down (−y)."},
  ...
  {"id": "identify_poles_from_lines", "tags": ["fieldlines"], "difficulty": "med", "type": "mcq", "prompt": "Field lines are drawn just ABOVE a bar magnet (outside the magnet) with arrows pointing left → right. Which end is the NORTH pole?", "choices": ["Left end", "Right end", "Cannot tell from arrows", "Neither end"], "answerIndex": 0, "explanation": "Outside a magnet, field lines go N → S. Just above the magnet, arrows left → right means the left end is N and the right end is S. (Inside the magnet, direction is S → N.)"},
