...
// Predecessor's revision 4 FINAL pack integrated 2026-05-10
// Last editor save: 2026-05-08T21:17:08.396Z (revision 3 baseline)
// 204 base questions
// Type mix: short 7, mcq 130, matching 10, grid 9, fillblank 10, categorise 7, multiselect 25, ordering 5, numeric 1
// Active: 204, Parked: 0
// ============================================================================
...
window.PREIB_RAD_QUESTIONS = [
  ...
  },
  {
    ...
    "type": "matching",
    "atoms": [
      "proton_neutron_similar_mass",
      "electron_negligible_mass"
    ],
  ...
  },
  {
    ...
    "atoms": [
      ...
      "electron_charge_neg1",
      "electron_negligible_mass",
      "nucleus_contains_protons_neutrons",
      "electrons_in_shells"
    ],
  ...
  },
  {
    ...
    "atoms": [
      "halflife_isotope_specific",
      "isotopes_chemically_identical",
      "chemistry_determined_by_electrons",
      "isotope_definition"
    ],
  ...
  },
  {
    ...
    "type": "matching",
    "atoms": [
      "halflife_independent_chemical_state",
      "decay_from_nucleus",
      "chemistry_determined_by_electrons",
      "mass_concentrated_in_nucleus"
    ],
  ...
  },
  {
    ...
    "type": "mcq",
    "atoms": [
      "irradiation_no_material_transfer"
    ],
  ...
  },
  {
    ...
    "atoms": [
      "irradiation_definition",
      "irradiation_no_material_transfer",
      "irradiation_stops_when_away",
      "contamination_definition",
      "contamination_persists_with_object",
      "contamination_internal_or_external"
    ],
  ...
  },
  {
    ...
    "type": "mcq",
    "atoms": [
      "internal_alpha_high_risk",
      "external_alpha_low_risk",
      "external_gamma_high_risk",
      "contamination_internal_or_external",
      "contamination_persists_with_object"
    ],
  ...
  },
  {
    ...
    "type": "short",
    "atoms": [
      "smoke_alarm_uses_alpha",
      "static_eliminator_uses_alpha",
      "spacecraft_power_uses_alpha"
    ],
  ...
  },
  {
    ...
    "type": "mcq",
    "atoms": [
      "smoke_alarm_property_short_range_ionising"
    ],
  ...
  },
  {
    ...
    "type": "mcq",
    "atoms": [
      "static_eliminator_property_ionises_air"
    ],
  ...
  },
  {
    ...
    "type": "mcq",
    "atoms": [
      "paper_foil_gauge_halflife_long",
      "steel_gauge_halflife_long"
    ],
  ...
  },
  {
    ...
    "atoms": [
      "sterilisation_uses_gamma",
      "injected_tracer_uses_gamma",
      "steel_gauge_uses_gamma",
      "pipe_leak_tracer_uses_gamma"
    ],
    "specRefs": [
      "7.14"
    ],
  ...
  },
  {
    ...
    "type": "mcq",
    "atoms": [
      "injected_tracer_property_escapes_body"
    ],
  ...
  },
  {
    ...
    "type": "mcq",
    "atoms": [
      "injected_tracer_halflife_short"
    ],
  ...
  },
  {
    ...
    "type": "mcq",
    "atoms": [
      "sterilisation_property_penetrates_packaging"
    ],
  ...
  },
  {
    ...
    "atoms": [
      "smoke_alarm_property_short_range_ionising",
      "paper_foil_gauge_property_partial_absorption",
      "sterilisation_property_penetrates_packaging",
      "injected_tracer_property_escapes_body",
      "implant_property_local_dose"
    ],
  ...
  },
  {
    ...
    "atoms": [
      "injected_tracer_halflife_short",
      "pipe_leak_tracer_halflife_short",
      "implant_halflife_medium",
      "smoke_alarm_halflife_long",
      "paper_foil_gauge_halflife_long",
      "sterilisation_halflife_long"
    ],
  ...
  },
  {
    ...
    "atoms": [
      ...
      "paper_foil_gauge_property_partial_absorption",
      "steel_gauge_uses_gamma",
      "steel_gauge_property_partial_absorption"
    ],
  ...
  },
  {
    ...
    "prompt": "Why is a sealed alpha source held at arm's length not particularly dangerous?",
    "choices": [
      "Alpha is absorbed by a few centimetres of air, so essentially none of it reaches the person",
    ...
    "explanation": "Alpha has very short range — about 2 to 5 cm in air. A sealed source at arm's length means essentially none of the alpha reaches the person, so the dose to body tissue is negligible. Important caveat: this 'safe externally' reasoning does NOT apply if the source is in contact with the body or has been swallowed or inhaled. That is contamination, where alpha is the most dangerous radiation because it deposits all its energy in nearby tissue."
  },
  {
  ...
  },
  {
    ...
    "type": "categorise",
    "atoms": [
      "dose_depends_on_activity",
      "dose_depends_on_distance",
      "dose_depends_on_time",
      "dose_depends_on_radiation_type",
      "dose_depends_on_shielding"
    ],
  ...
  },
  {
    ...
    "atoms": [
      "internal_alpha_high_risk",
      "internal_beta_intermediate",
      "internal_gamma_low_risk"
    ],
  ...
  },
  {
    ...
    "marks": 1,
    "atoms": [
      "halflife_long_means_low_activity",
      "long_halflife_long_danger"
    ],
  ...
  },
  {
    ...
    "atoms": [
      "fission_releases_more_neutrons"
    ],
    "specRefs": [
      "7.18"
    ],
  ...
  },
  {
    ...
    "atoms": [
      "inhaled_lung_tracer_uses_gamma",
      "inhaled_lung_tracer_halflife_very_short"
    ],
    "specRefs": [
      "7.14",
      "7.12"
  ...
  {
    "id": "halflife_unaffected_by_multiselect",
    "type": "multiselect",
    "tags": [
      "halflife",
      "atomic_struct"
    ...
    "difficultyRating": 2,
    "marks": 3,
    "prompt": "The half-life of a radioactive isotope is a fixed quantity. Tick all the changes you could make to a sample that would NOT affect its half-life.",
    "choices": [
      "heating the sample to 1000 °C",
      "compressing the sample under high pressure",
      "dissolving the sample in acid (chemical reaction)",
      "switching to a different isotope of the same element",
      "reducing the number of nuclei in the sample by half",
      "putting the sample in a magnetic field"
    ],
    "answerIndices": [
      0,
      1,
    ...
    "distractorRationales": {
      "3": "Different isotopes have different half-lives; that IS a change that affects half-life. The other ticks are about external/physical conditions, which don't.",
      "4": "Reducing the number of nuclei doesn't affect the half-life either, but it does affect the activity (decays per second). The point of half-life being independent is that conditions on the sample don't change it; the question is about conditions, not what 'half-life' means."
    },
    "markingMode": "penalty",
    "explanation": "Half-life is determined by the physics of the nucleus, which is shielded from atomic-orbital-level effects. Heating, compressing, putting the sample in a chemical reaction, or applying a magnetic field all change the electrons' state, not the nucleus.",
    "examinerNote": "This question covers all three external-factors atoms in positive form: temperature (tick 0), pressure (tick 1), chemical state (tick 2). A magnetic-field option is included as a fourth correct tick because it follows the same principle. Distractor 3 is a conceptual trap (different isotope IS a change that affects half-life — but it's not a change to a sample, it's a change of sample). Distractor 4 distinguishes activity (which depends on number of nuclei) from half-life (which doesn't).",
    "atoms": [
      "halflife_independent_temp",
      "halflife_independent_pressure",
      "halflife_independent_chemical_state"
    ]
  },
  {
    "id": "rtg_radiation_choice_multiselect",
    "type": "multiselect",
    "tags": [
      "uses_alpha",
      "choosing_isotopes_for_uses",
    ...
    "difficultyRating": 3,
    "marks": 4,
    "prompt": "A radioisotope thermoelectric generator (RTG) on a deep-space probe uses radioactive decay to produce heat, which is then converted into electricity. Tick all the genuine reasons why an alpha-emitter with a half-life of decades (such as plutonium-238) is the right choice.",
    "choices": [
      "alpha is highly ionising and short-range, so its energy is deposited locally as heat in a small block",
      "the alpha doesn't escape the spacecraft to harm electronics or astronauts",
      "a half-life of decades means the heat output stays roughly constant over the multi-decade mission",
      "gamma would be wasted: most would escape the heating block without depositing energy",
      "alpha is the only radiation that can be converted directly to electricity",
      "a short half-life would be safer because the source decays before causing harm"
    ],
    "answerIndices": [
      0,
      1,
    ...
    "distractorRationales": {
      "4": "An RTG uses heat as the intermediate; electricity comes from a thermoelectric converter, not directly from the radiation. Any radiation depositing heat would in principle work; alpha is preferred because it deposits heat efficiently.",
      "5": "A short half-life would mean the spacecraft loses power within the mission. Long-mission RTGs need long half-lives so the heat output (and electrical output) lasts."
    },
    "markingMode": "penalty",
    "explanation": "RTGs need a radiation that deposits its energy efficiently as heat in a small region (alpha's high ionising power and short range), and a source whose activity barely changes over decades (long half-life). Plutonium-238 (half-life 87 years) meets both. The Voyager probes have used Pu-238 RTGs since 1977 and still have power in 2026.",
    "examinerNote": "Single multiselect covers all three RTG atoms: radiation choice (tick 0,3), property (tick 0,1), half-life class (tick 2). Distractor 4 catches the 'alpha → electricity directly' misconception. Distractor 5 catches the 'shorter half-life is safer' misconception.",
    "atoms": [
      "spacecraft_power_uses_alpha",
      "spacecraft_power_property_local_heating",
      "spacecraft_power_halflife_very_long"
    ]
  },
  {
    "id": "choose_isotope_for_static_eliminator_mcq",
    "type": "mcq",
    "tags": [
      "choosing_isotopes_for_uses",
      "uses_alpha",
    ...
    "difficultyRating": 2,
    "marks": 1,
    "prompt": "An industrial conveyor in a printing factory uses a small radioactive source to remove static charge from rolls of plastic film as they move past. Which isotope is the most suitable choice for the source in the static eliminator?",
    "choices": [
      "an alpha-emitter with a half-life of many years",
      "an alpha-emitter with a half-life of a few hours",
      "a gamma-emitter with a half-life of many years",
    ...
    "answerIndex": 0,
    "distractorRationales": {
      "1": "Half-life too short. The source would lose half its activity within hours, and the static-eliminator effectiveness would drop. An industrial conveyor runs for years.",
      "2": "Gamma is too penetrating: it would escape the eliminator and irradiate workers nearby. Gamma is also less effective at ionising air locally — that's alpha's job.",
      "3": "Beta would partially escape the eliminator (less local containment than alpha), and a few-seconds half-life would make the source useless within minutes."
    },
    "explanation": "A static eliminator needs alpha (highly ionising, short range, contained in the device) and a long half-life (years) so the eliminator works reliably over the conveyor's operational lifetime. Polonium-210 (half-life 138 days) and americium-241 (half-life 432 years) are typical choices.",
    "examinerNote": "Combined-probe parallel to the seven existing choose-isotope mcqs. Tests both `static_eliminator_uses_alpha` (already covered) and `static_eliminator_halflife_long` (newly covered).",
    "atoms": [
      "static_eliminator_uses_alpha",
      "static_eliminator_halflife_long"
    ]
  },
  {
    "id": "pipe_leak_gamma_multiselect",
    "type": "multiselect",
    "tags": [
      "uses_gamma",
      "choosing_isotopes_for_uses"
    ...
    "difficultyRating": 2,
    "marks": 3,
    "prompt": "A small amount of radioactive isotope is added to the water in a buried pipe network to find a suspected leak. Workers walk above the ground with a Geiger counter; the leak shows up as a higher count rate where the radioactive water has reached the surrounding soil. Tick all the genuine reasons why a gamma-emitter is used.",
    "choices": [
      "gamma can pass through the metal pipe wall to escape the pipe",
      "gamma can pass through metres of soil to reach the surface where it is detected",
      "alpha would be absorbed by the water in the pipe and never escape it",
      "gamma is the cheapest radiation to produce in large quantities",
      "alpha and beta cannot be added to water at all",
      "the gamma is converted to heat in the soil, which the workers also detect"
    ],
    "answerIndices": [
      0,
      1,
    ...
    "distractorRationales": {
      "3": "Cost isn't the deciding factor; physics is. Gamma is chosen because it's the only one that reaches the surface.",
      "4": "Any radioactive substance can be dissolved in water. The radiation is what differs.",
      "5": "Geiger counters detect ionising radiation directly, not heat from the soil."
    },
    "markingMode": "penalty",
    "explanation": "Pipe leak detection requires the radiation to escape the pipe (passing through the metal pipe wall) and travel up through the soil to the surface where workers walk with detectors. Only gamma is penetrating enough; alpha would be absorbed by the water itself, beta by the pipe wall.",
    "examinerNote": "Mirrors `gamma_tracer_multiselect`. Both this and choose_isotope_for_pipe_leak_mcq probe the application; this one in positive multiselect form, the other as choose-isotope.",
    "atoms": [
      "pipe_leak_tracer_uses_gamma",
      "pipe_leak_tracer_property_reaches_surface"
    ]
  },
  {
    "id": "double_activity_double_dose_mcq",
    "type": "mcq",
    "tags": [
      "bio_effects"
    ],
    ...
    "difficultyRating": 2,
    "marks": 1,
    "prompt": "A worker stands at a fixed distance from a radioactive source for a fixed time. The source is then replaced with one of identical type but DOUBLE the activity, and the worker stands at the same distance for the same time. Compared to the first dose, the second dose is approximately:",
    "choices": [
      "double",
      "the same",
      "half",
    ...
    "answerIndex": 0,
    "distractorRationales": {
      "1": "The dose depends on activity. Double the activity means double the decays per second, so double the radiation arriving at the worker per second.",
      "2": "Halving would happen if the activity were halved, not doubled.",
      "3": "Doubling activity doesn't square to four times. The relationship is linear: double the decay rate, double the dose."
    },
    "explanation": "The dose received is the total energy deposited in the tissue, which is proportional to how many decays reach the worker. Doubling the activity doubles the number of decays per second, and over the same time and at the same distance and with the same radiation type, the dose doubles.",
    "examinerNote": "Positive-form probe of the dose ∝ activity relationship. Distractors test the inverse-square misconception (four times) and the no-relationship misconception (same dose).",
    "atoms": [
      "dose_depends_on_activity"
    ]
  },
  {
    "id": "beta_intermediate_danger_mcq",
    "type": "mcq",
    "tags": [
      "which_most_dangerous",
      "bio_effects"
    ...
    "difficultyRating": 3,
    "marks": 1,
    "prompt": "Compared to alpha and gamma, beta radiation is sometimes described as having an 'intermediate' danger profile. Which statement best explains what is meant by this?",
    "choices": [
      "Beta is moderately ionising (less than alpha, more than gamma) and has moderate range, so neither external nor internal exposure makes it the most dangerous radiation",
      "Beta is the most dangerous radiation in every context",
      "Beta is harmless in every context",
      "Beta is only dangerous when it is the only radiation present"
    ],
    "answerIndex": 0,
    "distractorRationales": {
      "1": "Beta is never the most dangerous. Alpha is most dangerous internally; gamma is most dangerous externally. Beta sits in the middle in both contexts.",
      "2": "Beta is harmful in both contexts; just less so than the most dangerous radiation in each context.",
      "3": "Beta's danger doesn't depend on what other radiations are present."
    },
    "explanation": "External exposure: alpha doesn't reach you (absorbed in air); gamma fully reaches you (highly penetrating); beta partially reaches you (absorbed by ~1 m of air or thin shielding). So gamma is the worst external. Internal exposure: alpha deposits all its energy in nearby tissue; gamma passes through; beta does some of each. So alpha is the worst internal. In both cases beta is the second-worst — never the worst, never harmless.",
    "examinerNote": "Positive probe of beta's intermediate character; covers both the external and internal beta atoms in registry #4. The 'intermediate' framing is the bank's own (used in the danger_external_vs_internal_grid examinerNote).",
    "atoms": [
      "external_beta_intermediate",
      "internal_beta_intermediate"
    ]
  },
  {
    ...
    "difficultyRating": 1,
    "marks": 1,
    "prompt": "Where in an atom are the electrons found?",
    "choices": [
      "In shells (energy levels) around the nucleus",
      "Inside the nucleus, alongside protons and neutrons",
      "Spread evenly throughout the atom's volume",
      "Only in the gaps between atoms"
    ],
    "answerIndex": 0,
    "distractorRationales": {
      "1": "Electrons are NOT in the nucleus. The nucleus contains only protons and neutrons.",
      "2": "Electrons aren't 'spread evenly' — they occupy specific shells / energy levels around the nucleus.",
      "3": "Atoms aren't separated by gaps in this way; electrons belong to specific atoms."
    },
    "explanation": "Electrons are arranged in shells (also called energy levels) around the nucleus. The innermost shell is closest to the nucleus and fills first. The number of electrons in each shell determines the atom's chemistry.",
    "examinerNote": "Direct positive probe of the `electrons_in_shells` atom, complementing the existing where_in_atom_mcq (which tests the multi-particle location structure).",
    "atoms": [
      "electrons_in_shells"
    ]
  }
